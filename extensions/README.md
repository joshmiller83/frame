...
- **`LEGEND-<id>.md`**: The generated vocabulary list (human/LLM readable).
...
The `tools/generate_extension.py` script is a developer utility. It reads an `extension.yml`, fetches data from an upstream source (via an adapter), and generates the `LEGEND-<id>.md` file.
